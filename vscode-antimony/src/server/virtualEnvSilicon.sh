...
ve() {
    ...
    # virtualenv ~/[${venv}]
    sudo -u $USER /Users/evaliu/Downloads/Vscode_Antimony_Setup/bin/python3.9 -m venv $HOME/${venv} --system-site-package
    echo "Upgrading pip"
    $HOME/${venv}/bin/python3 -m pip install --upgrade pip
