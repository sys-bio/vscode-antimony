...
from stibium.ant_types import (FuncCall, IsAssignment, VariableIn, FunctionCall, UnitAssignment, BuiltinUnit, UnitDeclaration, Annotation, ArithmeticExpr, Assignment, Atom, DeclModifiers,
                               ...
                               SubModelAssignment, SubModelConversionFactor, SubModelDelete, SubModelIsAssignment, SubModelList, SubModelReaction, SubModelRename, SubModelVar, SubModelVarMayBeIn, SubModelVariableConversionFactor, SubModelConversionFactorList,
...
TREE_MAP: Dict[str, Type[TreeNode]] = {
    ...
    'sub_model_var_maybein': SubModelVarMayBeIn,
...
KEYWORDS = {'ANNOT_KEYWORD', 'IN', 'MODEL', 'FUNCTION', "UNIT", "HAS", "IS", "SUBSTANCEONLY", "DELETE"}
